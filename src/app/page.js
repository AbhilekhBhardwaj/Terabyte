    ...
    <>
      ...
      <section className="hero">
        <div className="hero-bg">
          <img src="/home/dark_premium_background.png" alt="" />
        </div>
          ...
          <div className="hero-content">
            <div className="hero-header">
              <Copy animateOnScroll={false} delay={showPreloader ? 10 : 0.85}>
                <h1>Digital experiences that move brands forward</h1>
              </Copy>
            </div>
            <div className="hero-tagline">
              <Copy animateOnScroll={false} delay={showPreloader ? 10.15 : 1}>
                <p>
                  Terabox is a creative engineering studio crafting fast, accessible websites and apps—built to scale with your business.
                </p>
              </Copy>
            </div>
          ...
          <div className="what-we-do-header">
            <Copy delay={0.1}>
              <h1>
                ...
                We blend strategy, design, and engineering to deliver products that are beautiful, usable, and measurable.
              </h1>
            </Copy>
          </div>
      ...
      <section className="featured-projects-container">
        <div className="container">
          ...
          <div className="featured-projects-header">
            <Copy delay={0.15}>
              <h2>Recent launches and in‑progress builds</h2>
            </Copy>
          </div>
        </div>
        <FeaturedProjects />
