        ...
        <div className="menu-wrapper">
          <div className="col col-1">
            <div className="links">
              ...
              <div className="link">
                <a href="/our-clients" onClick={(e) => handleLinkClick(e, "/our-clients")}>
                  <h2>Our Clients</h2>
                </a>
              </div>
              <div className="link">
                <a href="/our-services" onClick={(e) => handleLinkClick(e, "/our-services")}>
                  <h2>Our Services</h2>
                </a>
              </div>
            </div>
            ...
            <div className="socials">
              <div className="sub-col">
                <div className="menu-meta menu-commissions">
                  <p>Commissions</p>
                  <p>build@terabox.agency</p>
                  <p>+1 (872) 441‑2086</p>
                </div>
                <div className="menu-meta">
                  <p>Our Address</p>
                  <p>MILLIONAIRE HERITAGE, SV ROAD</p>
